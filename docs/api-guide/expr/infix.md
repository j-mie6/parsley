...
lazy val expr = infix.left1(num)("+".as(Add.apply))
lazy val num = digit.foldLeft1(0)((n, d) => n * 10 + d.asDigit).map(Num.apply)
...
```scala mdoc:fail
lazy val badExpr = infix.right1(num)("+".as(Add.apply))
```
