...
is defined as being an object which mocks a package):
  ...
  - [[parsley.templates `parsley.templates`]] contains some basic implementations of
    ...
    or the parsley wiki): these can be used before more specialised template bridge traits are
    constructed.
