...
object debug {
    ...
    implicit class DebugCombinators[P, A](p: P)(implicit con: P => Parsley[A]) {
        ...
        private [parsley] def debug(name: String, break: Breakpoint, coloured: Boolean): Parsley[A] = {
            debug(name, break, coloured, Seq.empty[(Ref[_], String)]: _*)
        }
        ...
        /** $debug
          ...
          * @param watchedRefs Which references to also track the values of and their names, if any
          */
        def debug(name: String, break: Breakpoint, watchedRefs: (Ref[_], String)*): Parsley[A] = debug(name, break, coloured = true, watchedRefs: _*)

        private [parsley] def debug(name: String, break: Breakpoint): Parsley[A] = debug(name, break, Seq.empty[(Ref[_], String)]: _*)
        ...
        /** $debug
          ...
          * @param watchedRefs Which references to also track the values of and their names, if any
          */
        def debug(name: String, coloured: Boolean, watchedRefs: (Ref[_], String)*): Parsley[A] = debug(name, break = NoBreak, coloured, watchedRefs: _*)

        private [parsley] def debug(name: String, coloured: Boolean): Parsley[A] = debug(name, coloured, Seq.empty[(Ref[_], String)]: _*)
        ...
        /** $debug
          ...
          * @param watchedRefs Which references to also track the values of and their names, if any
          */
        def debug(name: String, watchedRefs: (Ref[_], String)*): Parsley[A] = debug(name, break = NoBreak, coloured = true, watchedRefs: _*)

        private [parsley] def debug(name: String): Parsley[A] = debug(name, Seq.empty[(Ref[_], String)]: _*)
