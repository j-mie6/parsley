...
/** This class is used to generate efficient expression parsers given a table of operators
  ...
  */
class ExpressionParser[A](atom: =>Parsley[A], table: OpList[A]*)
{
...
object ExpressionParser
{
    ...
    case class Infixes[A](assoc: Assoc, op: Parsley[(A, A) => A]*) extends OpList[A]
    case class Prefixes[A](op: Parsley[A => A]*) extends OpList[A]
    case class Postfixes[A](op: Parsley[A => A]*) extends OpList[A]
}