...
@deprecated("This object will be removed in Parsley 3.0, use `parsley.character` instead", "v2.1.0")
object Char
{
    // $COVERAGE-OFF$
    /** Reads a character from the input stream and returns it, else fails if the character is not found at the head
      ...
      */
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.char` instead", "v2.1.0")
    ...
    /** Reads a character from the head of the input stream if and only if it satisfies the given predicate. Else it
      ...
      */
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.satisfy` instead", "v2.1.0")
    ...
    /** Reads a string from the input stream and returns it, else fails if the string is not found at the head
      ...
      */
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.string` instead", "v2.1.0")
    ...
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.oneOf` instead", "v2.1.0")
    ...
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.noneOf` instead", "v2.1.0")
    ...
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.anyChar` instead", "v2.1.0")
    val anyChar: Parsley[Char] = parsley.character.anyChar

    /**Parses a whitespace character (either ' ' or '\t'). Returns the parsed character.*/
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.space` instead", "v2.1.0")
    val space: Parsley[Char] = parsley.character.space

    /**Skips zero or more whitespace characters. See also `skipMany`. Uses space.*/
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.spaces` instead", "v2.1.0")
    val spaces: Parsley[Unit] = parsley.character.spaces

    /**Parses a whitespace character (' ', '\t', '\n', '\r', '\f', '\v'). Returns the parsed character.*/
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.whitespace` instead", "v2.1.0")
    ...
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.whitespaces` instead", "v2.1.0")
    val whitespaces: Parsley[Unit] = parsley.character.whitespaces

    /**Parses a newline character ('\n'). Returns a newline character.*/
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.newline` instead", "v2.1.0")
    val newline: Parsley[Char] = parsley.character.newline

    /**Parses a carriage return character '\r' followed by a newline character '\n', returns the newline character.*/
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.crlf` instead", "v2.1.0")
    val crlf: Parsley[Char] = parsley.character.crlf

    /**Parses a CRLF or LF end-of-line. Returns a newline character ('\n').*/
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.endOfLine` instead", "v2.1.0")
    val endOfLine: Parsley[Char] = parsley.character.endOfLine

    /**Parses a tab character ('\t'). Returns a tab character.*/
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.tab` instead", "v2.1.0")
    val tab: Parsley[Char] = parsley.character.tab

    /**Parses an upper case letter. Returns the parsed character.*/
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.upper` instead", "v2.1.0")
    val upper: Parsley[Char] = parsley.character.upper

    /**Parses a lower case letter. Returns the parsed character.*/
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.lower` instead", "v2.1.0")
    val lower: Parsley[Char] = parsley.character.lower

    /**Parses a letter or digit. Returns the parsed character.*/
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.alphaNum` instead", "v2.1.0")
    val alphaNum: Parsley[Char] = parsley.character.alphaNum

    /**Parses a letter. Returns the parsed character.*/
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.letter` instead", "v2.1.0")
    val letter: Parsley[Char] = parsley.character.letter

    /**Parses a digit. Returns the parsed character.*/
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.digit` instead", "v2.1.0")
    val digit: Parsley[Char] = parsley.character.digit

    /**Parses a hexadecimal digit. Returns the parsed character.*/
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.hexDigit` instead", "v2.1.0")
    val hexDigit: Parsley[Char] = parsley.character.hexDigit

    /**Parses an octal digit. Returns the parsed character.*/
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.octDigit` instead", "v2.1.0")
    ...
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.isWhitespace` instead", "v2.1.0")
    ...
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.isHexDigit` instead", "v2.1.0")
    ...
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.isOctDigit` instead", "v2.1.0")
    ...
    @deprecated("This method will be removed in Parsley 3.0, use `parsley.character.isSpace` instead", "v2.1.0")
